...
// IntrLine3Cylinder3FI. The protected DoQuery member is exported as the
// module function 'intrLine3Cylinder3FIDoQuery'.
...
export function intrLine3Cylinder3FIDoQuery(lineOrigin: Vector, lineDirection: Vector,
...
export class IntrLine3Cylinder3FI implements
    ...
    find(line: Line, cylinder: Cylinder3): IntrLine3Cylinder3FIResult {
        ...
        intrLine3Cylinder3FIDoQuery(line.origin, line.direction, cylinder,
            result);
        if (result.intersect) {
            for (let i = 0; i < 2; ++i) {
